...
describe Product do
  ...
  #     product2 = Product.create(name: "grapes", cost: 13, country_of_origin: "Spain")
  #     product3 = Product.create(name: "tomatoes", cost: 1, country_of_origin: "Japan")
  #     review1 = Review.create(author: "mitch paper", content_body: "blah blah blah sjdk lkj ljasdf lkasdjflkj asdlkjasd sjdkjl aslkdjds", rating: 1, product_id: 1)
  #     review2 = Review.create(author: "sally paper", content_body: "blah blah zffdg sjdk lkj ljasdf lkasdjflkj asdlkjasd sjdkjl aslkdjds", rating: 2, product_id: 1)
  #     review3 = Review.create(author: "chet paper", content_body: "blah blah sdfg sjdk lkj ljasdf lkasdjflkj asdlkjasd sjdkjl aslkdjds", rating: 3, product_id: 1)
  #     review4 = Review.create(author: "bill paper", content_body: "blah blah gfds sjdk lkj ljasdf lkasdjflkj asdlkjasd sjdkjl aslkdjds", rating: 4, product_id: 2)
  #     review5 = Review.create(author: "steve paper", content_body: "blah blah hjjh sjdk lkj ljasdf lkasdjflkj asdlkjasd sjdkjl aslkdjds", rating: 5, product_id: 2)
